...
def save_snapshot(snapshot ,customers, adjusters, agents, policies, policies_data, claims, claims_data):
    with open(f'{snapshot}_customers.csv', mode='w', newline='', encoding='utf-8') as file:
        writer = csv.DictWriter(file, fieldnames=customers[0].keys())
        writer.writeheader()
        writer.writerows(customers)

    with open(f'{snapshot}_adjusters.csv', mode='w', newline='', encoding='utf-8') as file:
        writer = csv.DictWriter(file, fieldnames=adjusters[0].keys())
        writer.writeheader()
        writer.writerows(adjusters)

    with open(f'{snapshot}_agents.csv', mode='w', newline='', encoding='utf-8') as file:
        writer = csv.DictWriter(file, fieldnames=agents[0].keys())
        writer.writeheader()
        writer.writerows(agents)

    with open(f'{snapshot}_policies.csv', mode='w', newline='', encoding='utf-8') as file:
        writer = csv.DictWriter(file, fieldnames=policies[0].keys())
        writer.writeheader()
        writer.writerows(policies)

    with open(f'{snapshot}_policies_data.csv', mode='w', newline='', encoding='utf-8') as file:
    ...
    with open(f'{snapshot}_claims_data.csv', mode='w', newline='', encoding='utf-8') as file:
